...
class GTSMSViewContact extends GTView {
	...
	public function display($tpl = null) {		
		...
		// Set page title
		if($layout == 'edit') {
			$this->page_title = $this->isNew ? JText::_('COM_GTSMS_PT_NEW') : JText::_('COM_GTSMS_PT_EDIT');
			$this->page_title = str_replace('%s', JText::_('COM_GTSMS_CONTACT'), $this->page_title);
