...
<div class="form-inline">
	<div class="form-group">
		<div class="input-group input-xlarge">
			<input class="form-control" name="filter_search" type="text" value="<?php echo $this->escape($this->state->get('filter.search')); ?>"  placeholder="<?php echo JText::_('COM_GTSMS_FIND_DESC') ?>" id="filter_search">
			<div class="input-group-btn">
				...
				<button class="btn btn-cyan" type="submit">
					<i class="fa fa-search"></i> <?php echo JText::_('COM_GTSMS_FIND')?>
				</button>
			</div>
		</div>
	</div>
