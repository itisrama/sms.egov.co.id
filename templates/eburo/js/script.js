...
(function($) {
	$(document).ready(function() {
		...
		$('.t3-nav-sidebar li.active').closest('li.active').addClass('open');

		$('.t3-nav-sidebar li').unbind('mouseleave');
		...
		function setHeight() {
			...
			if($('html').hasClass('guest')) {
				...
				$('.t3-page-wrapper').css('min-height', windowHeight-headerHeight-footerHeight);
			}
		};
